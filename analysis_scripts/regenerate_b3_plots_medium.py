"""
Regenerate B3 plots for medium difficulty with correct numbers from actual run.
"""
...
ax.set_title("Position Bias Metrics: Effect of Reasoning\n(Medium difficulty, n=500 pairs)", fontsize=12, fontweight='bold')
ax.set_xticks(x)
...
fig.tight_layout()
fig.savefig("results/b3_by_difficulty/figures/b3_position_bias_comparison_medium.png", dpi=150, bbox_inches='tight')
plt.close(fig)
print("Saved: b3_position_bias_comparison_medium.png")
...
fig.tight_layout()
fig.savefig("results/b3_by_difficulty/figures/b3_bias_components_medium.png", dpi=150, bbox_inches='tight')
plt.close(fig)
print("Saved: b3_bias_components_medium.png")

print("\n✓ Medium difficulty plots regenerated with correct numbers")
